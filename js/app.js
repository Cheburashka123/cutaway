...
$('.switch').click(function () {
    ...
    $('.decoration').toggleClass('bglightOn');
    $('.lightbulb').toggleClass('bulbLightOn');
    $('.shadow, .menu,.switch-cover').toggleClass('_active');

});


$('.menu__item, .return').click(function () {
    $('.page').toggleClass('_active');
    $('.menu').toggleClass('_close');
...
$(document).ready(function () {
    ...
    let myAge = calculate_age(new Date(2005, 10, 17));
    $('#age').text(myAge);
...
//    let w = $('.shadow ').innerWidth(),
//        h = $('.shadow ').innerHeight(),
//        t = e.pageY - $('.shadow ').offset().top,
//        l = e.pageX - $('.shadow ').offset().left;
//    $('.shadow ').css('background-image', 'radial-gradient(circle at ' + (l / w * 100) + '% ' + (t / h * 100) + '%, transparent 40px, rgba(0, 0, 0, 0.8) 60px)');
//});
